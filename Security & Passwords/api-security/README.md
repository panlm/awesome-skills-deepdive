...
> 实现安全 API 设计模式，包括认证、授权、输入验证和速率限制
...
| **名称** | api-security |
| **作者** | brandonwise |
| **ClawHub** | https://clawskills.sh/skills/brandonwise-api-security |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/brandonwise/api-security |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
| **名称** | ClawdStrike |
| **作者** | misirov |
| **ClawHub** | https://clawskills.sh/skills/misirov-clawdstrike |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/misirov/clawdstrike |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

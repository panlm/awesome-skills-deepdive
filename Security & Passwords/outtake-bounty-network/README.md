...
| 项目 | 内容 |
|---|---|
| **名称** | outtake-bounty-network |
| **作者** | jamesouttake |
| **ClawHub** | https://clawskills.sh/skills/jamesouttake-outtake-bounty-network |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/jamesouttake/outtake-bounty-network |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
> 基于 HSM 的 AI Agent 密钥管理 — 安全存储、检索、轮换和共享密钥
...
| **名称** | 1claw |
| **作者** | kmjones1979 |
| **ClawHub** | https://clawskills.sh/skills/kmjones1979-1claw |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/kmjones1979/1claw |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
> 不可篡改的 Agent 行为审计日志（存储于 TiDB Zero）
...
| **名称** | black-box |
| **作者** | lilyjazz |
| **ClawHub** | https://clawskills.sh/skills/lilyjazz-black-box |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/lilyjazz/black-box |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
| **名称** | clawdbites |
| **作者** | kylelol |
| **ClawHub** | https://clawskills.sh/skills/kylelol-clawdbites |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/kylelol/clawdbites |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

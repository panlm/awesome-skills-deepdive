...
> 从 WeatherFlow Tempest 气象站获取实时天气数据
...
| **名称** | tempest-weather |
| **作者** | wranglerdriver |
| **ClawHub** | https://clawskills.sh/skills/wranglerdriver-tempest-weather |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/wranglerdriver/tempest-weather |
| **许可证** | MIT |
| **安全评级** | 🟡 Medium |

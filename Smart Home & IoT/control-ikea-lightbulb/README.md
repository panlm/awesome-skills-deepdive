...
| **作者** | antgly |
| **ClawHub** | https://clawskills.sh/skills/antgly-control-ikea-lightbulb |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/antgly/control-ikea-lightbulb |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

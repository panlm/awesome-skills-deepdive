...
| **名称** | frigate |
| **作者** | porygonthebot |
| **ClawHub** | https://clawskills.sh/skills/porygonthebot-frigate |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/porygonthebot/frigate |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
| **名称** | govee-lights |
| **作者** | joeynyc |
| **ClawHub** | https://clawskills.sh/skills/joeynyc-govee-lights |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/joeynyc/govee-lights |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |
...
## 依赖和前提条件
- Get API key from [Govee Developer Portal](https://developer.govee.com/)

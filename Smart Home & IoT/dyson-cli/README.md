...
> 通过命令行工具控制 Dyson 智能设备（空气净化器/风扇/加湿器）
...
| **名称** | dyson-cli |
| **作者** | tmustier |
| **ClawHub** | https://clawskills.sh/skills/tmustier-dyson-cli |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/tmustier/dyson-cli |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

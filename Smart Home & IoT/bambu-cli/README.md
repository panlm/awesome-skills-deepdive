...
> 通过 bambu-cli 命令行工具操控和排障 BambuLab 3D 打印机
...
| **名称** | bambu-cli |
| **作者** | tobiasbischoff |
| **ClawHub** | https://clawskills.sh/skills/tobiasbischoff-bambu-cli |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/tobiasbischoff/bambu-cli |
| **许可证** | 未指定 |
| **安全评级** | 🟢 Low |

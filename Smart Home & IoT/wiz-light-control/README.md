...
> 控制 WiZ 智能灯泡的开关、亮度和颜色

## 基本信息
| 项目 | 内容 |
|---|---|
| **名称** | wiz-light-control |
| **作者** | canbirlik |
| **ClawHub** | https://clawskills.sh/skills/canbirlik-wiz-light-control |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/canbirlik/wiz-light-control |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

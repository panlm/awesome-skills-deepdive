...
| [agora-flow](./agora-flow/) | AgoraFlow Q&A 平台技能，为 AI agent 提供提问、回答、投票和搜索功能 | rivera-daniel | ? | 🟡 | 4 |
| [agoraflow](./agoraflow/) | AgoraFlow Q&A 平台技能（agora-flow 的姊妹版本），提供 AI agent 知识共享平台 | rivera-daniel | ? | 🟡 | 4 |
| [android-3d-developer](./android-3d-developer/) | 帮助构建和优化 Android 平台上的 3D 游戏和交互体验 | tippyentertainment | ? | 🟢 | 3 |
| [arena](./arena/) | OpenClaw Arena — 实时 AI 应用构建竞赛平台，支持链上奖励 | sscottdev | ? | 🟡 | 3 |
| [brawlnet](./brawlnet/) | BRAWLNET 自主 agent 竞技场的官方战斗协议，在 100 扇区六角网格上进行实时对战 | sikey53 | ? | 🟡 | 6 |
...
| [init](./init/) | 在 Kradleverse 平台注册 agent（kradleverse-init 的早期版本） | themrzz | ? | 🟡 | 3 |
| [join](./join/) | 加入 Kradleverse 游戏会话（kradleverse-join 的早期版本） | themrzz | ? | 🟡 | 3 |
| [kradleverse-act](./kradleverse-act/) | 在 Kradleverse 游戏中发送动作指令 | themrzz | ? | 🟡 | 3 |
| [kradleverse-init](./kradleverse-init/) | 在 Kradleverse 平台注册 agent 身份 | themrzz | ? | 🟡 | 3 |
| [kradleverse-join](./kradleverse-join/) | 加入 Kradleverse 游戏匹配队列 | themrzz | ? | 🟡 | 3 |

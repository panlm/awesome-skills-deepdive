...
> 内存安全的语音转录工具，自动分片处理，支持 16GB 内存机器

## 基本信息
| 项目 | 内容 |
|---|---|
| **名称** | auto-whisper-safe |
| **作者** | neal-collab |
| **ClawHub** | https://clawskills.sh/skills/neal-collab-auto-whisper-safe |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/neal-collab/auto-whisper-safe |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

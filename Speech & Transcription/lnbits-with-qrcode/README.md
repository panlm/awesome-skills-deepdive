...
| **名称** | lnbits |
| **作者** | jamestsetsekas |
| **ClawHub** | https://clawskills.sh/skills/jamestsetsekas-lnbits-with-qrcode |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/jamestsetsekas/lnbits-with-qrcode |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

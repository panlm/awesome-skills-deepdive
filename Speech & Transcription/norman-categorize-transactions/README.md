...
| 项目 | 内容 |
|---|---|
| **名称** | categorize-transactions |
| **作者** | stanlee000 |
| **ClawHub** | https://clawskills.sh/skills/stanlee000-norman-categorize-transactions |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/stanlee000/norman-categorize-transactions |
| **许可证** | 未指定 |
| **安全评级** | 🟢 Low |

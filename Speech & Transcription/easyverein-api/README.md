...
> 通过 Easyverein API 管理社团/协会成员和活动
...
| **名称** | easyverein-api |
| **作者** | truefoobar |
| **ClawHub** | https://clawskills.sh/skills/truefoobar-easyverein-api |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/truefoobar/easyverein-api |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

...
> 通过 alexacli 命令行控制 Amazon Alexa 设备和智能家居
...
| **名称** | alexa-cli |
| **作者** | buddyh |
| **ClawHub** | https://clawskills.sh/skills/buddyh-alexa-cli |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/buddyh/alexa-cli |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

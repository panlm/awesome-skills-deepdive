...
> 按需生成有声书、播客或教育音频内容（AI 编写脚本 + ElevenLabs 语音合成）
...
| **名称** | audio-gen |
| **作者** | udiedrichsen |
| **ClawHub** | https://clawskills.sh/skills/udiedrichsen-audio-gen |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/audio-gen |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

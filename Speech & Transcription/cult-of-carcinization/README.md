...
| 项目 | 内容 |
|---|---|
| **名称** | cult-of-carcinization |
| **作者** | loserbcc |
| **ClawHub** | https://clawskills.sh/skills/loserbcc-cult-of-carcinization |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/loserbcc/cult-of-carcinization |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

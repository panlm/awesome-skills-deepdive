...
| 项目 | 内容 |
|---|---|
| **名称** | Feishu Voice Assistant |
| **作者** | autogame-17 |
| **类目** | 媒体与流媒体 |
| **ClawHub** | https://clawskills.sh/skills/autogame-17-feishu-voice-assistant |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/autogame-17/feishu-voice-assistant |
| **安全评级** | 🟡 Medium |

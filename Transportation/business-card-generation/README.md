...
| 项目 | 内容 |
|---|---|
| **名称** | Business Card Generation |
| **作者** | eftalyurtseven |
| **类目** | Transportation |
| **ClawHub** | https://clawskills.sh/skills/eftalyurtseven-business-card-generation |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/eftalyurtseven/business-card-generation |
| **安全评级** | 🟡 Medium |

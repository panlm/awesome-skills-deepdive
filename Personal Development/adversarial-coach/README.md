...
| **作者** | killerapp |
| **ClawHub** | https://clawskills.sh/skills/killerapp-adversarial-coach |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/killerapp/adversarial-coach |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

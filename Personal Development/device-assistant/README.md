...
| **名称** | device-assistant |
| **作者** | udiedrichsen |
| **ClawHub** | https://clawskills.sh/skills/udiedrichsen-device-assistant |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/device-assistant |
| **许可证** | MIT |
| **安全评级** | 🟡 Medium |

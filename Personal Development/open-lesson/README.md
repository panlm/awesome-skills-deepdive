...
| **名称** | open-lesson |
| **作者** | dncolomer |
| **ClawHub** | https://clawskills.sh/skills/dncolomer-open-lesson |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/dncolomer/open-lesson |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

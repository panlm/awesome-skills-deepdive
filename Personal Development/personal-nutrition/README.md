...
> 个人营养管理 — 饮食追踪、营养建议和健康饮食规划

## 基本信息
| 项目 | 内容 |
|---|---|
| **名称** | personal-nutrition |
| **作者** | gekacross |
| **ClawHub** | https://clawskills.sh/skills/gekacross-personal-nutrition |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/gekacross/personal-nutrition |
| **许可证** | 未指定 |
| **安全评级** | 🟢 Low |
...
- Extract the skill folder to `/data/.openclaw/workspace/skills/`
- Restart the container: `docker restart openclaw-ewcl-openclaw-1`

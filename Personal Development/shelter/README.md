...
| **名称** | shelter |
| **作者** | code-with-brian |
| **ClawHub** | https://clawskills.sh/skills/code-with-brian-shelter |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/code-with-brian/shelter |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |
...
- `install-skill.js` — 脚本文件
- `package.json` — 配置/数据文件
- `references/` — 目录
- `uninstall-skill.js` — 脚本文件

...
| 项目 | 内容 |
|---|---|
| **名称** | zeitgaist-dialect |
| **作者** | newsoulontheblock |
| **ClawHub** | https://clawskills.sh/skills/newsoulontheblock-zeitgaist-dialect |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/newsoulontheblock/zeitgaist-dialect |
| **许可证** | 未指定 |
| **安全评级** | 🟡 Medium |

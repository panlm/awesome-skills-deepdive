...
| 项目 | 内容 |
|---|---|
| **名称** | Blank Files Gateway |
| **作者** | seblavoie |
| **类目** | PDF & Documents |
| **ClawHub** | https://clawskills.sh/skills/seblavoie-blankfiles |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/seblavoie/blankfiles |
| **安全评级** | 🟢 Low |

...
- Bot API file limit is 50 MB — not 4 GB like Telegram user clients. For larger files, you'd need a Local Bot API Server (
- Caption vs message body: When attaching media, `content` becomes the caption (max 1,024 chars). For text-only posts, con

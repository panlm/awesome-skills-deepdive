...
| **名称** | voice-wake-say |
| **作者** | xadenryan |
| **ClawHub** | https://clawskills.sh/skills/xadenryan-voice-wake-say |
| **GitHub** | https://github.com/openclaw/skills/tree/main/skills/xadenryan/voice-wake-say |
| **安全评级** | 🟢 Low (低风险) |
...
Reads assistant responses aloud on macOS using the built-in `say` command. Activates only when the user message starts with the exact phrase \
